...
<div class="container-fluid p-0">
    <h2 class="h3 mb-3"><strong>Profil Kasir</strong></h2>

    <div class="card">
        <div class="card-body">
            <form id="profileForm" method="POST" action="{{ route('kasir.profile.update') }}"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        ...
                        @else
                        <img src="{{ url('kasirAssets/img/avatars/avatar.jpg') }}" alt="Foto Profil"
                            class="img-thumbnail mb-2" style="max-width: 150px;">
                        @endif
                ...
                <div class="mb-3 row">
                    <label for="new_password_confirmation" class="col-sm-2 col-form-label">Konfirmasi Password
                        Baru</label>
                    <div class="col-sm-10">
...
@section('scripts')
    ...
    <script>
        ...
        if (message === 'Profil berhasil diperbarui.') {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        profileForm.addEventListener('submit', function (e) {
            ...
            function submitForm() {
                ...
                fetch("{{ route('kasir.profile.update') }}", {
                    method: 'POST',
                    headers: {
                ...
                // Optionally reset password fields except current_password
                ...
                if (data.profile_photo_path) {
                    ...
                    // Also update profile photo on profile page
