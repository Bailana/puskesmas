                                    ...
                                    @foreach ($pasiens_ugd as $index => $pasien)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning btn-sm ms-1 btn-riwayat-analisa" data-bs-toggle="modal"
                                                    data-bs-target="#modalRiwayatAnalisa" data-pasien-id="{{ $pasien->pasien_id }}"
                                                    data-nama-pasien="{{ $pasien->nama_pasien }}">Riwayat Analisa</button>
                                                <button type="button" class="btn btn-primary btn-sm ms-1 btn-periksa" data-bs-toggle="modal" data-bs-target="#modalPeriksa" data-pasien-id="{{ $pasien->pasien_id }}" data-nama-pasien="{{ $pasien->nama_pasien }}">Periksa</button>
