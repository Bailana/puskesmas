...
<head>
    ...
    <title>Kasir | UPT Puskesmas Pujud</title>
    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <div class="sidebar-brand d-flex align-items-center" href="{{ url('/kasir') }}">
                    <img src="{{ url('template/images/logo_puskesmas.png') }}" alt="Logo"
                        style="width: 50px; height: 50px; margin-right: 10px;">
                    <span class="align-middle">UPT PUSKESMAS PUJUD</span>
                </div>
                <ul class="sidebar-nav">
                    <li class="sidebar-item {{ Request::is('kasir') || Request::is('kasir/dashboard') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/kasir/dashboard') }}">
                            <i class="align-middle" data-feather="sliders"></i>
                            <span class="align-middle">Dashboard</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('kasir/pasien') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/kasir/pasien') }}">
                            <i class="align-middle" data-feather="user"></i>
                            <span class="align-middle">Data Pasien</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('kasir/antrian') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/kasir/antrian') }}">
                            <i class="align-middle" data-feather="users"></i>
                            <span class="align-middle">Antrian</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('kasir/dana-jasa-pelayanan') || Request::is('kasir/dana') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/kasir/dana') }}">
                            <i class="align-middle" data-feather="dollar-sign"></i>
                            <span class="align-middle">Dana Jasa Pelayanan</span>
                        </a>
                    </li>
