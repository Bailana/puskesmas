...
<div class="container-fluid p-0">
    <h2 class="h3 mb-3"><strong>Profil Dokter</strong></h2>

    <div class="card">
        <div class="card-body">
            <form id="profileForm" method="POST" action="{{ route('dokter.profile.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        profileForm.addEventListener('submit', function (e) {
            ...
            function submitForm() {
                ...
                fetch("{{ route('dokter.profile.update') }}", {
                    method: 'POST',
                    headers: {
