                ...
                <div id="hasilPeriksaDetail" style="display:none;">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Odontogram</th>
                                <td id="detailOdontogram"></td>
                            </tr>
                            <tr>
                                <th>Pemeriksaan Subjektif</th>
                                <td id="detailPemeriksaanSubjektif"></td>
                            </tr>
                            <tr>
                                <th>Pemeriksaan Objektif</th>
                                <td id="detailPemeriksaanObjektif"></td>
                            </tr>
                            <tr>
                                <th>Diagnosa</th>
                            ...
                            <tr>
                                <th>Terapi & Anjuran</th>
                                <td id="detailTerapiAnjuran"></td>
                            </tr>
                            <tr>
                                <th>Catatan</th>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('button[data-bs-target="#modalRiwayatBerobat"]').forEach(button => {
            button.addEventListener('click', function() {
                ...
                fetch(`/gigi/riwayat-berobat/${noRekamMedis}`)
                    .then(response => response.json())
                    .then(dates => {
                        if (dates.length === 0) {
                            ...
                            riwayatList.querySelectorAll('.btnLihat').forEach(btnLihat => {
                                btnLihat.addEventListener('click', function() {
                                    ...
                                    fetch(
                                            `/gigi/hasil-periksa-detail/${noRekamMedis}/${tanggal}`)
                                        .then(response => {
                                            if (!response.ok) {
                                                throw new Error(
                                        ...
                                        .then(data => {
                                            ...
                                            document.getElementById(
                                                ...
                                                .odontogram || '-';
                                            document.getElementById(
                                                    'detailPemeriksaanSubjektif')
                                                .textContent = data
                                                .pemeriksaan_subjektif || '-';
                                            document.getElementById(
                                                    'detailPemeriksaanObjektif')
                                                .textContent = data
