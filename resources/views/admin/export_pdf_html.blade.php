...
<head>
    ...
    <style>
        ...
        .header-table .center-cell .line1 {
            font-size: 16px;
        }
        .header-table .center-cell .line2 {
            font-size: 14px;
        }
        table {
            width: 100%;
...
<body>
    <div class="kop-surat">
        <table class="header-table" style="border-collapse: collapse; border: none;">
            <tr>
                <td class="logo-cell" style="border: none;">
                    ...
                    @endphp
                    <img src="{{ $base64Left }}" alt="Logo Kiri" style="width: 80px; height: 80px; object-fit: contain;">
                </td>
                <td class="center-cell" style="border: none;">
                ...
                <td class="logo-cell" style="border: none;">
                    ...
                    @endphp
                    <img src="{{ $base64Right }}" alt="Logo Kanan" style="width: 80px; height: 80px; object-fit: contain;">
                </td>
            </tr>
        </table>
    </div>
