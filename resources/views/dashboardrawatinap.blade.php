        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    <li class="sidebar-item {{ Request::is('rawatinap/dashboard') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/rawatinap/dashboard') }}">
                            <i class="align-middle" data-feather="sliders"></i>
                            <span class="align-middle">Dashboard</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ Request::is('rawatinap/pasien') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/rawatinap/pasien') }}">
                    ...
                    <li class="sidebar-item {{ Request::is('rawatinap/rawatinap') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ url('/rawatinap/rawatinap') }}">
